...
This repository contains materials for comparing beam emittance calculations between MATLAB and [pyemittance](https://github.com/slaclab/pyemittance) at SLAC's LCLS injector (OTR2 screen `OTRS:IN20:571`).
